...
![](file-20251112170539525.jpg)



## 四.  添加和提交文件

![](file-20251112170539632.jpg)
...
![](file-20251112170539690.png)



### **3.  将文件加入到工作区**

![](file-20251112170539767.png)

此时仓库的状态如下			`git status`		<!--查看仓库当前状态-->

![](file-20251112170539855.png)

### **4.  提交文件到仓库**

`git commit -m "提交说明"`						

![](file-20251112170539905.png)



`git commit`				若无-m,则会自动进入一个交互界面,默认会使用vim来编辑提交信息

![](file-20251112170539979.png)

可以使用方向键移动光标

使用`i`键进入编辑模式,输入提交信息

![](file-20251112170540059.png)

按esc回到命令模式,输入`:wq`保存退出

![](file-20251112170540132.png)
...
```
 ...
 将aaa.txt文档的内容修改如下![](file-20251112170540516.png)
...
此时提示合并冲突
![[file-20251112170540662.png]]

同时文件内容也发生改变

![](file-20251112170540710.png)

此时需要手动处理冲突, 手工编辑文件内容

![](file-20251112170540795.png)
